...
| *deadLetterTopic* (consumer) | Name of the topic where the messages which fail \{maxRedeliverCount\} times will be sent. Note: if not set, default topic name will be --DLQ |  | String
